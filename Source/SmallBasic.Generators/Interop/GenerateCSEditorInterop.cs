// <copyright file="GenerateCSEditorInterop.cs" company="MIT License">
...
namespace SmallBasic.Generators.Interop
{
    ...
    public sealed class GenerateCSEditorInterop : BaseConverterTask<InteropTypeCollection>
    {
        ...
        {
            this.Line("namespace SmallBasic.Editor.Interop");
            this.Brace();

            this.Line("using System.Threading.Tasks;");
            this.Line("using Microsoft.JSInterop;");
            this.Line("using SmallBasic.Compiler.Services;");
            this.Blank();
